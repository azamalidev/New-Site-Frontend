...
// Importing the exact social media icons
...
const Header_Top = () => {
    ...
    return (
        <header className="bg-white  text-green-700 py-2 px-4">
            <div className="container mx-auto flex flex-wrap justify-between items-center">
                {/* Left Section: Address */}
                <div className="flex items-center justify-start !space-x-2 h-auto">
                ...
                {/* Middle Section: Social Icons (Visible only on large screens) */}
                <div className="flex space-x-5 hidden lg:flex"> {/* Social icons hidden on small screens */}
