        ...
        <div className="container mx-auto">
          <div className="text-center mb-10">
            ...
            <div className="hr-theme-slash-2 flex items-center justify-center mb-6">
              ...
              <div className="hr-icon text-lg font-medium text-yellow-100 uppercase">Understanding the Guidelines</div>
              <div className="hr-line w-1/4 h-1 bg-yellow-300 mx-2"></div>
            </div>
          </div>
          ...
          <div className="space-y-12 text-lg text-gray-200">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">2. Eligibility and Registration</h3>
              <p>
            ...
            {/* Changes to Terms */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">3. Changes to Terms</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">4. Services and Content</h3>
              <p>
            ...
            {/* Payment and Fees */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">5. Payment and Fees</h3>
              <p>
            ...
            {/* User Conduct */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">6. User Conduct</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">7. Privacy and Data Protection</h3>
              <p>
            ...
            {/* Third-Party Links */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">8. Third-Party Links</h3>
              <p>
            ...
            {/* Disclaimers */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">9. Disclaimers</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">10. Limitation of Liability</h3>
              <p>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">11. Intellectual Property</h3>
              <p>
            ...
            {/* Termination */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">12. Termination</h3>
              <p>
            ...
            {/* Governing Law */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">13. Governing Law</h3>
              <p>
            ...
            {/* Contact Information */}
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-yellow-300 text-opacity-80">14. Contact Information</h3>
              <p>
